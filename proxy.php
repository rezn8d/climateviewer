...
if (empty($url)) {
    die("<html><head><title>ACCESS DENIED | No Soup For You</title><style>body,html{width:100%;height:100%;margin:0;padding:0;overflow:hidden;background:#FFF}#uhuhuh{position:absolute;top:0;left:0;width:100%;height:100%;overflow:hidden;clear:both;text-align:center;margin:0;z-index:1}#warning{position:absolute;bottom:0;left:0;width:100%;overflow:hidden;clear:both;text-align:center;margin:0;background:#000;color:#00FF1D;z-index:9002}#eye-see-you{position:absolute;top:0;left:0;width:100%;height:100%;opacity:.3;overflow:hidden;clear:both;text-align:center;margin:0;background:url(http://r3zn8d.files.wordpress.com/2014/03/matrix-green.gif);background-attachment:fixed;background-repeat:no-repeat no-repeat;-webkit-background-size:cover;-moz-background-size:cover;-o-background-size:cover;background-size:cover;z-index:9001}.noselect{-moz-user-select:none;-khtml-user-select:none;-webkit-user-select:none;user-select:none}#loginform{display:none}h1,h3{display:block;margin:3px 0;font-weight:700}</style><script>$(document).ready(function(){var t=document.documentElement.clientWidth,e=document.documentElement.clientHeight;$('#uhuhuh').height(e).width(t),$('img').height(e).width(t)})</script></head><body class='noselect'><iframe allowfullscreen frameborder=0 id=uhuhuh src=http://www.youtube.com/embed/QDySGUFAom0?loop=1&feature=player_embedded&autoplay=1&controls=0&modestbranding=1&rel=0&showinfo=0&autohide=1&color=white&theme=light1></iframe><div id=warning><h3>Your actions have been logged in our</h3><h1 style=color:#FFF>Climate Viewer Failbot Hall of Shame.</h1><h3>Y U try to break in our server?</h3></div><div id=eye-see-you><form action=127.0.0.1 id=loginform method=post name=loginform><p><label for=user_login>Username<br><input id=user_login name=log class=input autocomplete=off clickev=true keyev=true mouseev=true size=20></label><p><label for=user_pass>Password<br><input id=user_pass name=pwd class=input autocomplete=off clickev=true keyev=true mouseev=true size=20 type=password></label><div><p class=forgetmenot><label for=rememberme><input id=rememberme name=rememberme type=checkbox value=forever> Remember Me</label><p class=submit><input id=wp-submit name=wp-submit class=1button button-large button-primary1type=submit value=1Log In1></form></div></body></html>");
