...
if ($('body').hasClass('mobile')) {
    // is mobile
    viewer = new Cesium.Viewer('cesiumContainer',{ sceneModePicker: false, timeline: true, animation: true,  sceneMode: Cesium.SceneMode.SCENE2D, navigationHelpButton : false, navigationInstructionsInitiallyVisible : false, imageryProvider: false, baseLayerPicker: false, clock: clock, terrainProvider: false  });
} else {
    // is desktop
    viewer = new Cesium.Viewer('cesiumContainer',{ sceneModePicker: false, timeline: true, animation: true, sceneMode: Cesium.SceneMode.SCENE3D, navigationHelpButton : false, navigationInstructionsInitiallyVisible : false, imageryProvider: false, baseLayerPicker: false, clock: clock, terrainProvider: false  });
}
