...
$('.go-flying').click(function () {
    ...
    $(this).after('<p class="instruct footer">Press <strong>W A S D</strong> on on your keyboard and Aim with your mouse (hold left mouse button).  Reload page to end flight. Flight is still experimental.</p>');
    $(this).remove();
});
