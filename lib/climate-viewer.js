...
var viewer = new Cesium.Viewer('cesiumContainer',{timeline: true, navigationHelpButton : false, navigationInstructionsInitiallyVisible : false, imageryProvider: false, baseLayerPicker: false, clock: clock, terrainProvider: false  });
...
$('.go-flying.mouse').click(function () {
    ...
    $(this).removeClass('mouse').addClass('keys');
    $('.go-flying.keys').one('click', function() {
        console.log('unbound');
        ...
        $(this).removeClass('keys').addClass('mouse');
    });
});
