...
function resize() {
    var buttonOffset = $('.tabmenu-footer').height(),
    ...
    $('.tabmenu-body').height(clientHeight - buttonOffset);
...
if ($('body').hasClass('mobile')) {
    // is mobile
    var viewer = new Cesium.Viewer('cesiumContainer',{ sceneModePicker: false, sceneMode: Cesium.SceneMode.SCENE2D, navigationHelpButton : false, navigationInstructionsInitiallyVisible : false, imageryProvider: false, baseLayerPicker: false, clock: clock, terrainProvider: false  });
} else {
    // is desktop
    var viewer = new Cesium.Viewer('cesiumContainer',{ sceneModePicker: false, sceneMode: Cesium.SceneMode.SCENE3D, navigationHelpButton : false, navigationInstructionsInitiallyVisible : false, imageryProvider: false, baseLayerPicker: false, clock: clock, terrainProvider: false  });
}
