...
function disableLayer(l) {
    ...
    // Update Globe
    if (l.hasClass("nasa-gibs") || l.hasClass("wms")) {
        removeImagery(layerId);
    } else if (l.hasClass("base-layer")) {
        removeBaseLayer(layerId);
    } else {
        var src = activeLayers[l.attr('href')];
        delete activeLayers[l.attr('href')];
