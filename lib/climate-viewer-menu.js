        ...
        if (typeof l === "string") {
            ...
            if (l.section) {
                ...
                if (present) {
                    ...
                    var lbe = $('<a>').addClass('layer-label nslider-overlay').attr('id', l.id).html(l.name);

                    var lbg = NSlider({
                        'element': $('<div class="layer-slider">').append(lbe),
                        'onChange': function(v) {

                        }
                    }).appendTo($('<span>').addClass('layer-slider-wrap').appendTo(lbd));
