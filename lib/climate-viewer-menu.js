...
function enableLayer(b, force) {
    if (force) {
        ...
        var success = function success(geoData) {
            ...
            var details = $('<ul class="layer-details ' + layerId + '" />');
            b.after(details);
...
function loadLayers(includeOnly) {
    ...
    for (var i = 0; i < layers.length; i++) {
        ...
        if (typeof l === "string") {
            ...
            if (l.section) {
                if (!includeOnly) {
                    lbd.html($('<h4>').append('<i class="section-icon ' + l.icon + '"></i>').append(l.section));
                }
            } else if (l.id) {
                var present = true;
                if (includeOnly) {
                ...
                if (present) {
                    if (!lbd) {
                        ...
                        lbc = $('<div id="collapseShared" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingShared"></div>').appendTo(lb);
                        lbd = $('<div></div>').appendTo(lbc);
                    }
                    ...
                    (function() {
                        ...
                        var sliderWrap = $('<span>').addClass('layer-slider-wrap').appendTo(lbd).append(
