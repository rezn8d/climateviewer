...
function addTree(parent/* nodes  */, lb /*target */, includeOnly) {
    ...
    _.each(layers, function (l) {
        ...
        if (typeof l === "string") {
            ...
            if (!includeOnly) {
                //section heading
                lb.append($('<div class="title active">').append($('<h4>').text(l)));


                //var lbc = $('<div>').appendTo(lb);
                //var lbd = $('<div>').appendTo(lbc);
            ...
            if (l.section) {
                if (!includeOnly) {
                    //subsection heading
                    content = $('<h4>').append('<i class="section-icon ' + l.icon + '"></i>').append(l.section);
                }
            } else if (l.I) {
                var present = true;
                if (includeOnly) {
                ...
                if (present) {
                    var layerId = l.I;
                    var sourceUrl = layerId; //TODO change to real value
                    var source = layerId; //TODO change to real value
                    ...
                    var initDetails = function () {
                        ...
                        $('<li class="">' + source + ' &bull; <a href="' + sourceUrl + '" target="_blank" rel="nofollow">More Info</a></li>').appendTo(details);
                        ...
                        $('<li class=""><strong>Share:</strong> <a class="btn btn-xs btn-info" href="' + baseURL + 'index.html?layersOn=' + layerId + '">This Layer</a> <a href="#shareModal" class="btn btn-xs btn-info" data-toggle="modal" data-target="#shareModal">Active Layers</a></li>').appendTo(details);
                    ...
                    content = $('<span>').data('l', l).addClass('layer-slider-wrap').append(
                        $('<div style="float: left" class="layer-control-buttons">').append(
                            ...
                            $('<a><i class="fa fa-plus fa-2x"></i></a>').click(function (e) {
                                e.preventDefault();
                            ...
                            $('<a><i class="fa fa-sliders fa-2x"></i></a>').click(function () {
                        ...
                        nslider = NSlider({
                            'element': $('<div class="layer-slider">').append(icon),
            ...
            if (content!=null) {
                var child = $('<ul>').html(l);
                lb.append(content).append($('<ul>').append(child));
            }

            //var successors = self.successors(l);
            //if (successors && successors.length > 0) {
            addTree(l.I, child, includeOnly);
            //}
