  ...
  if (force && b.hasClass('btn-default')) {
    ...
    if (b.hasClass("wms")) {
      ...
      new Cesium.GeoJsonDataSource.load(geoDataSrc, {
        markerSymbol: 'cross', // icon names https://www.mapbox.com/maki/
        markerSize: '48',
...
menuToggle.tooltip({
    placement: 'right',
    title: 'Click here to toggle the layer menu'
});
function showT() {
    $('.toggle-menu').tooltip('toggle');
}
setTimeout(showT, 500);
setTimeout(showT, 7000);
/*
function resize() {
