        ...
        if (typeof l === "string") {
            ...
            if (l.section) {
                ...
                if (present) {
                    ...
                    /*
                     if (l.baseLayer) lbe.addClass('base-layer');
                     if (l.geojson === 'usgs-eq') lbe.addClass('geojson usgs-eq');
                     if (l.wms) lbe.addClass('wms');
                     if (l.wmts) lbe.addClass('wtms');
                     if (l.wmts === 'nasa-gibs') lbe.addClass('nasa-gibs');
                     if (l.kml === 'neo') lbe.addClass('neo');
                     if (l.kml) lbe.addClass('kml');
                     if (l.zoom) lbe.addClass('zoom');
                     */
                }
            }
