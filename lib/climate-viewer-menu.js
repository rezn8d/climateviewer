...
function loadGeoJson(layerId, geoDataSrc, markerLabel, markerScale, markerImg, markerColor) {
    ...
    if (layerEnabled[layerId] === undefined) {
        ...
        if (l.T === ("wms")) {
           ...
           loadOsmLayer(layerId, geoDataSrc);
            ...
            loadGeoJson(layerId, geoDataSrc, markerLabel, markerScale, markerImg, markerColor);
        } else if (l.T === ('kml')) {
        ...
        if (!l.T) {
            ...
            if (present) {
                ...
                content = $('<div>').data('l', l).attr('id', l.I).addClass('lbw').append(
                    $('<div>').addClass('lb').append( // layer button
                        ...
                        label = $('<span>').html(l.N).addClass('label').toggle(
                          function () { 
