...
function loadLayers(includeOnly) {
    ...
    lb.addClass('ui inverted accordion');
    ...
    _.each(layers, function (l) {
        ...
        if (typeof l === "string") {
            ...
            if (!includeOnly) {
                //section heading
                lb.append($('<div class="title">').append($('<h4>').text(l)));
                ...
                if (present) {
                    ...
                    content = $('<span>').addClass('layer-slider-wrap').append(
                        ...
                        nslider = NSlider({
                            ...
                            $('<a>').addClass('layer-label nslider-overlay').attr('id', l.id).html(l.name)
                        ),
                    ...
                    /*
                     var layerLink = $('<a id="' + l.id + '" class="btn btn-default btn-sm" href="' + l.geoDataSrc + '" data-layers="' + l.wmsLayers + '" data-source="' + l.source + '" data-source-url="' + l.sourceURL + '"><i class="fa "></i> ' + l.name + '</a>').appendTo(lbe);
                     */
            ...
            if (content!=null)
                lb.append($('<div class="content">').append( content ));
