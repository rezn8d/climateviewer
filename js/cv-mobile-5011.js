...
function loadSliders(src, layerId, datePicker) {
    ...
    var sPanel = $('<div class="ui card ' + layerId + '-sliders layer-sliders" />').insertAfter(target);
