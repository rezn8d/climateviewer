          ...
          if (l.image || l.video) {
              ...
              if (typeof l.image == "string") {
                var flickr = new RegExp("flickr.com");
                  if (flickr.test(l.image)) {
                    footerBtns.append('<a href="' + l.image + 'player/" title="' + l.image + '" class="btn btn-default image-link mfp-iframe" target="_blank" rel="nofollow"><span class="glyphicon glyphicon-picture" aria-hidden="true"></span> Image</a>');
                  } else {
                    footerBtns.append('<a class="btn btn-default image-link" href="' + l.image + '" target="_blank" rel="nofollow"><span class="glyphicon glyphicon-picture" aria-hidden="true"></span> Image</a>');
                  }
              } else {
                _.each(l.image, function(theImage) {
                  var flickr = new RegExp("flickr.com");
                    if (flickr.test(theImage)) {
                      footerBtns.append('<a href="' + theImage + 'player/" title="' + theImage + '" class="btn btn-default image-link mfp-iframe" target="_blank" rel="nofollow"><img src="' + theImage + 'player/" class="" alt="image" /></a>');
                    } else {
                      footerBtns.append('<a class="btn btn-default image-link" href="' + theImage + '" target="_blank" rel="nofollow"><img src="' + theImage + '" class="" alt="image" /></a>');
                    }
                });
              }
            }
            if (l.video) {
              if (typeof l.video == "string") { 
                footerBtns.append('<a title="View Media" class="btn btn-default video-link mfp-iframe" href="' + l.video + '"><div class="videoWrapper"><div class="youtube" id="' + l.video + '" data-params="modestbranding=1&showinfo=0&controls=0&vq=hd720" style="width: 750px; height: 451px;"></div></div></a>');
              } else {  
               _.each(l.video, function(theVideo) {
                  footerBtns.append('<a title="View Media" class="btn btn-default video-link mfp-iframe" href="' + theVideo + '"><div class="videoWrapper"><div class="youtube" id="' + theVideo + '" data-params="modestbranding=1&showinfo=0&controls=0&vq=hd720" style="width: 750px; height: 451px;"></div></div></a>');
                });
              }
            }
          } // end media
