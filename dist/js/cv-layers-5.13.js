...
var layers = {
    ...
    Live: {
        N: "Alerts",
        Disasters: {
            N: "Disasters", icon: "fa-exclamation-circle", '>': [
                {
        ...
        Volcano: {
            N: "Volcano", icon: "fa-exclamation-triangle", '>': [
                {
                    I: "kml-volcano",
                    P: true,
                    M: true,
    ...
    weather: {
        ...
        radar: {
            N: "Weather Radar", icon: "fa-signal", '>': [
                {
                    X: true,
                    I: "mesonet-nexrad",
                    T: 'wms',
        ...
        ra: {
            N: "Radar Animations", TRD: true, icon: "fa-film", '>': [
                {
                    P: true,
                    I: "kml-nexradcgl",
                    Z: true,
        ...
        surface: {
            N: "Surface Observations", icon: "fa-location-arrow", '>': [
                {
                    I: "nws_wfo_conus",
                    T: 'arcgis-layer',
        ...
        rain: {
            N: "Precipitation", icon: "fa-umbrella", ">": [
                {
                    I: "usdroughtoutlook",
                    T: 'arcgis-layer',
        ...
        canes: {
            N: "Tropical Cyclones", icon: "fa-cloud", '>': [
                {
    ...
    satellites: {
        N: "Satellites",
        sat: {
            N: "Satellite Imagery", icon: "fa-globe", '>': [
                {
        ...
        satAnimation: {
            N: "Satellite Animations", icon: "fa-film", '>': [
                {
                    P: true,
                    C: true,
                    I: "sat15",
    ...
    pollution: {
        ...
        toxicrelease: {
            N: "Toxic Release", H: true, icon: "fa-exclamation-triangle", '>': [
                {
                    I: "epa-tri",
                    H: true,
                    T: 'geojson',
        ...
        toxicwaste: {
            N: "U.S. EPA Superfund Sites", icon: "fa-bug", H: true, '>': [
                {
                    H: true,
                    Z: true,
                    I: "epa01",
...
/*            {
    ...
    MRM: {
        N: "MyReadingMapped",
        MRMSunkenShips: {
            N: "Abandoned and Sunken Ships", icon: "fa-ship", '>': [
                {
                    P: true,
                    Z: true,
                    I: "mrm-01",
        ...
        MRMAncientRuins: {
            N: "Ancient Ruins", icon: "fa-university", '>': [
                {
                    P: true,
                    Z: true,
                    I: "mrm-09",
        ...
        MRMArchitecture: {
            N: "Architecture", icon: "fa-building-o", '>': [
                {
                    P: true,
                    Z: true,
                    I: "mrm-18",
        ...
        MRMConquerors: {
            N: "Conquerors and Wars", icon: "fa-fighter-jet", '>': [
                {
                    P: true,
                    Z: true,
                    I: "mrm-34",
        ...
        MRMCrimeSprees: {
            N: "Crime Sprees", icon: "fa-user-secret", '>': [
                {
                    P: true,
                    Z: true,
                    I: "mrm-55",
        ...
        MRMDisease: {
            N: "Disease Outbreaks", icon: "fa-hospital-o", '>': [
                {
                    P: true,
                    Z: true,
                    I: "mrm-60",
        ...
        MRMGeoscience: {
            N: "Geoscience and Oceanography", icon: "fa-globe", '>': [
                {
                    P: true,
                    Z: true,
                    I: "mrm-111",
        ...
        MRMGreenEnergy: {
            N: "Green Energy Solutions", icon: "fa-recycle", '>': [
                {
                    P: true,
                    Z: true,
                    I: "mrm-133",
        ...
        MRMLandscapePaintings: {
            N: "Landscape Painting Sites", icon: "fa-tint", '>': [
                {
                    P: true,
                    Z: true,
                    I: "mrm-136",
        ...
        MRMMountainClimbs: {
            N: "Mountain Climbing Expeditions", icon: "fa-area-chart", '>': [
                {
                    P: true,
                    Z: true,
                    I: "mrm-147",
        ...
        MRMPlaneCrashSites: {
            N: "Plane Crash Sites", icon: "fa-plane", '>': [
                {
                    P: true,
                    Z: true,
                    I: "mrm-155",
        ...
        MRMTrainCrashSites: {
            N: "Train Crash Sites", icon: "fa-train", '>': [
                {
                    P: true,
                    Z: true,
                    I: "mrm-156",
        ...
        MRMWorldFairOlympics: {
            N: "World Fairs and Olympics", icon: "fa-trophy", '>': [
                {
                    P: true,
                    Z: true,
                    I: "mrm-159",
    ...
    other: {
        ...
        boats: {
            N: "Marine Traffic", icon: "fa-anchor", '>': [
                {
                    P: true,
                    I: "kml-noaabuoy",
                    T: 'kml',
